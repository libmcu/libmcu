...
static bool has_rfid_tagged(void *ctx) {
	return mock().actualCall(__func__).returnBoolValueOrDefault(false);
}

static bool has_remotely_started(void *ctx) {
	return mock().actualCall(__func__).returnBoolValueOrDefault(false);
}

static bool has_remotely_stopped(void *ctx) {
	return mock().actualCall(__func__).returnBoolValueOrDefault(false);
}
...
static bool has_hardware_error(void *ctx) {
	return mock().actualCall(__func__).returnBoolValueOrDefault(false);
}
...
static void turn_relay_on(void *ctx) {
	mock().actualCall(__func__);
}

static void turn_relay_off(void *ctx) {
	mock().actualCall(__func__);
}
