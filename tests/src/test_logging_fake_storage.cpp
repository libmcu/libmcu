...
TEST(FakeStorage, write_ShouldConvertDataToString) {
	const char *fixed_string = "1599652568: [VERBOSE] <0x558d66c5d4db> Hello, World";
	uint8_t data[] = {
...
TEST(FakeStorage, write_ShouldConvertDataToString_WhenTypeIsDebug) {
	const char *fixed_string = "1599652568: [DEBUG] <0x558d66c5d4db> Hello, World";
	uint8_t data[] = {
		0xd8, 0xc2, 0x58, 0x5f, 0x00, 0x00, 0x00, 0x00,
		0xdb, 0xd4, 0xc5, 0x66, 0x8d, 0x55, 0x00, 0x00,
		0xb2, 0xde, 0xc6, 0x66, 0x8d, 0x55, 0x00, 0x00,
...
TEST(FakeStorage, write_ShouldConvertDataToString_WhenTypeIsInfo) {
	const char *fixed_string = "1599652568: [INFO] <0x558d66c5d4db> Hello, World";
	uint8_t data[] = {
		0xd8, 0xc2, 0x58, 0x5f, 0x00, 0x00, 0x00, 0x00,
		0xdb, 0xd4, 0xc5, 0x66, 0x8d, 0x55, 0x00, 0x00,
		0xb2, 0xde, 0xc6, 0x66, 0x8d, 0x55, 0x00, 0x00,
...
TEST(FakeStorage, write_ShouldConvertDataToString_WhenTypeIsNotice) {
	const char *fixed_string = "1599652568: [NOTICE] <0x558d66c5d4db> Hello, World";
	uint8_t data[] = {
		0xd8, 0xc2, 0x58, 0x5f, 0x00, 0x00, 0x00, 0x00,
		0xdb, 0xd4, 0xc5, 0x66, 0x8d, 0x55, 0x00, 0x00,
		0xb2, 0xde, 0xc6, 0x66, 0x8d, 0x55, 0x00, 0x00,
...
TEST(FakeStorage, write_ShouldConvertDataToString_WhenTypeIsWarn) {
	const char *fixed_string = "1599652568: [WARN] <0x558d66c5d4db> Hello, World";
	uint8_t data[] = {
		0xd8, 0xc2, 0x58, 0x5f, 0x00, 0x00, 0x00, 0x00,
		0xdb, 0xd4, 0xc5, 0x66, 0x8d, 0x55, 0x00, 0x00,
		0xb2, 0xde, 0xc6, 0x66, 0x8d, 0x55, 0x00, 0x00,
...
TEST(FakeStorage, write_ShouldConvertDataToString_WhenTypeIsError) {
	const char *fixed_string = "1599652568: [ERROR] <0x558d66c5d4db> Hello, World";
	uint8_t data[] = {
		0xd8, 0xc2, 0x58, 0x5f, 0x00, 0x00, 0x00, 0x00,
		0xdb, 0xd4, 0xc5, 0x66, 0x8d, 0x55, 0x00, 0x00,
		0xb2, 0xde, 0xc6, 0x66, 0x8d, 0x55, 0x00, 0x00,
...
TEST(FakeStorage, write_ShouldConvertDataToString_WhenTypeIsAlert) {
	const char *fixed_string = "1599652568: [ALERT] <0x558d66c5d4db> Hello, World";
	uint8_t data[] = {
		0xd8, 0xc2, 0x58, 0x5f, 0x00, 0x00, 0x00, 0x00,
		0xdb, 0xd4, 0xc5, 0x66, 0x8d, 0x55, 0x00, 0x00,
		0xb2, 0xde, 0xc6, 0x66, 0x8d, 0x55, 0x00, 0x00,
...
TEST(FakeStorage, write_ShouldConvertDataToString_EvenWhenUnknownType) {
	const char *fixed_string = "1599652568: [UNKNOWN] <0x558d66c5d4db> Hello, World";
	uint8_t data[] = {
		0xd8, 0xc2, 0x58, 0x5f, 0x00, 0x00, 0x00, 0x00,
		0xdb, 0xd4, 0xc5, 0x66, 0x8d, 0x55, 0x00, 0x00,
		0xb2, 0xde, 0xc6, 0x66, 0x8d, 0x55, 0x00, 0x00,
